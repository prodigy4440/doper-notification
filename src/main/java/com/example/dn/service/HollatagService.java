...
import com.example.dn.config.HollatagProperties;
...
@Service
@Slf4j
public class HollatagService implements SmsGateway {

    private final HollatagProperties properties;
    private final JsonService jsonService;
    private final OkHttpClient client;

    public HollatagService(HollatagProperties properties, JsonService jsonService) {
    ...
    public SmsResponse sendSms(SmsRequest sms) {
        String url = properties.getUrl() + "/api/v1/hollatag/send/sms";
